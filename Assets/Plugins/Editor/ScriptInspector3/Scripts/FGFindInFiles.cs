...
public static class FGFindInFiles
{
	...
	static List<string> FindReferenceCandidates(SymbolDefinition symbol, string localAssetPath)
	{
		...
		result.Sort((a, b) => {
			...
			var aIsCs = a.EndsWith(".cs", System.StringComparison.OrdinalIgnoreCase) ? 1 : 0;
			var bIsCs = b.EndsWith(".cs", System.StringComparison.OrdinalIgnoreCase) ? 1 : 0;
			if (aIsCs != 0 && bIsCs != 0)
				return bIsCs - aIsCs;
			
			var aIsJsOrBoo = a.EndsWith(".js", System.StringComparison.OrdinalIgnoreCase)
				|| a.EndsWith(".boo", System.StringComparison.OrdinalIgnoreCase);
			var bIsJsOrBoo = b.EndsWith(".js", System.StringComparison.OrdinalIgnoreCase)
				|| b.EndsWith(".js", System.StringComparison.OrdinalIgnoreCase);
